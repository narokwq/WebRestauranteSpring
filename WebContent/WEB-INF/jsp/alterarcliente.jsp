        ...
        <form:form name="formC" class="form-inline"  id="formulario-cadastro" action="${url}" method="post" modelAttribute="cliente" >
               ...
               <legend style="font: bold 18px/45px sans-serif;">Informações Pessoais</legend>
				...
				<div class="form-group" >                    
                    <label for="cEmail" class="col-sm-2 form-control-label">Email:</label> 
                    	...
                    	<div class="col-sm-10"> 
                        <p>	<form:input path="dataNasc" class="form-control" id="cData" type="date" name="dataNasc"  /> </p>
               	 		</div>
                </div>
            </fieldset>
            <fieldset name="fieldEndereco" id="endereco" >
                ...
                <div class="form-group">
                     ...
                     <div class="col-sm-10"> 
                        <p>	<form:input path="endereco.logradouro" class="form-control" id="cRua" type="text" name="endereco.logradouro"   /> </p>
               		 </div>
               
                     <label for="cNumero" class="col-sm-2 form-control-label">Número:</label>  
                     <div class="col-sm-10"> 
                     	<p>	<form:input path="endereco.numero" class="form-control" id="cNumero" type="text" name="endereco.numero"   /> </p>
                	 </div>
                
                     <label for="cComplemento" class="col-sm-2 form-control-label">Complemento:</label>     
                     <div class="col-sm-10"> 
                     	<p>	<form:input path="endereco.complemento" class="form-control" id="cComplemento" type="text" name="endereco.complemento"   /> </p>
                	 </div>
                
                     <label for="cBairro" class="col-sm-2 form-control-label">Bairro:</label>    
                     <div class="col-sm-10"> 
                     	<p>	<form:input path="endereco.bairro" class="form-control" id="cBairro" type="text" name="endereco.bairro"   /> </p>
                	 </div>
                
                     <label for="cCep" class="col-sm-2 form-control-label">CEP:</label>   
                     <div class="col-sm-10">   
                     	<p>	<form:input path="endereco.cep" class="form-control" id="cCep" type="text" name="endereco.cep" size="6" maxlength="9" placeholder="00000-000"   required="required" onkeypress="return mascaraCEP(this,'#####-###')" /> </p>
                	 </div>
               	
                     <label for="cPais" class="col-sm-2 form-control-label">País:</label>
                     <div class="col-sm-10"> 
                     	<p> <form:input path="endereco.pais" class="form-control" id="cPais" type="text" name="endereco.pais" required="required"  /> </p>
                	 </div>
               	 
	                     <label for="cEst"  class="col-sm-2 form-control-label">Estado:</label>
	                   	 <div class="col-sm-10">
	                   	 <p>
		                   	 <form:input id="cEst" name="endereco.estado" class="form-control"   path="endereco.estado" />		                    
                    	  </p>
	                	</div>
	                	
	                	<label for="cCidade" class="col-sm-2 form-control-label">Cidade:</label>
	                	<div class="col-sm-10"> 
	                		<form:input path="endereco.cidade" class="form-control" id="cCidade" type="text" name="endereco.cidade"   />	                		
	                	</div>
