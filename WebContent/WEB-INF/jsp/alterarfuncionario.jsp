            ...
            <fieldset id="dados-acesso">
                ...
                <div class="form-group">
                  <label for="cLogin" class="col-sm-2 form-control-label">Login:</label>
                	<div class="col-sm-10">
                	   <form:input path="login.login" class="form-control" type="text" size="16"  maxlength="20" placeholder="Login" required='required' />
               	   </div>
               	</div>
               	<!-- 
               	<div class="form-group">
                	...
                	<div class="col-sm-10">  
                		<form:input path="login.senha" class="form-control"  type="password" size="16"  maxlength="8" placeholder="Password" style="margin-left: 10px;" required='required' />
                	</div>	
           	   </div>	
           	    -->
            </fieldset>
               ...
               <legend style="font: bold 18px/45px sans-serif;">Informações Pessoais</legend>
               	<div class="form-group" >
          	     	<label for="cNome" class="col-sm-2 form-control-label">Nome:</label>    
	           	     	<div class="col-sm-10"> 
	            	     <p>	<form:input path="nome" class="form-control" type="text" size="30" maxlength="30" required='required' /> </p>
						</div>
				
					<label for="cTelefone" class="col-sm-2 form-control-label">Telefone:</label>    
						<div class="col-sm-10"> 	
						<p>	<form:input path="telefone" class="form-control" type="text" size="11" maxlength="14" placeholder="(00)00000-0000" onkeypress="return mascaraTEL(this,'(##)#####-####')" required='required' /> </p>
						</div>
				</div>
				<div class="form-group" >                    
                    <label class="col-sm-2 form-control-label">Email:</label> 
                    	<div class="col-sm-10"> 
                    	<p>	<form:input path="email" class="form-control" type="email" size="30" placeholder="nome@example.com" required='required' /> </p>
               	 		</div>
               	 		<form:errors  path="cpf"></form:errors>	
           	 		<label class="col-sm-2 form-control-label">Cpf:</label>  
                    	<div class="col-sm-10"> 
                        	<p>	       							
                        		<form:input path="cpf" class="form-control" type="text" size="14" maxlength="14" required='required' />                	
                       		</p>               	 			
               	 		</div>             	 	
           	 		<label class="col-sm-2 form-control-label">Salario</label>  
	                 	<div class="col-sm-1"> 
                     		<p>	       							
	                     		<form:input  path="salario" class="form-control" type="number" step="0.01" size="8" maxlength="8" required='required' />                	
                    		</p>               	 			
	            	 		</div>
                		</div>
                	<label class="col-sm-2 form-control-label">Cargo</label>
                 	<div class="col-sm-10" >           
                         <form:select path="cargo.id" class="form-control" required="required" >
